...
def run_localizer(cfg, cur_wkdir, test_data, prefix):
    ...
    with open(cur_wkdir / "boot_naive_fl.sh", 'w') as f:
    ...
    with open(cur_wkdir / 'naive_fl_output.log', 'w') as f:
        f.write("STDOUT:\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--localizer", "-l", help="path of naive_fl", required=True)
    ...
    parser.add_argument("--top-k", help="pick top-k", type=int, default=5)
