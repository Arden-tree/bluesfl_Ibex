...
The signal `adder_result_o` has been flagged as suspicious. The relevant code snippet is from the `ibex_alu` module and is intended to perform an addition. However,
...
The signal `pc_id_o` has been flagged as suspicious.
